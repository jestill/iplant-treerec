...
-- I had this at 950, but changed to 750 becuase I was getting
-- errors with INNODB tables.
...
ALTER TABLE reconciliation_set_attribute 
ADD CONSTRAINT reconciliation_set_attribute_fk1
FOREIGN KEY (cvterm_id)
REFERENCES cvterm (cvterm_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE family_attribute
ADD CONSTRAINT cvterm_family_attribute_fk1
FOREIGN KEY (cvterm_id)
REFERENCES cvterm (cvterm_id)
ON DELETE CASCADE
ON UPDATE CASCADE;
...
ALTER TABLE reconciliation_set_attribute
ADD CONSTRAINT reconciliation_set_attribute_fk2
FOREIGN KEY (reconciliation_set_id)
REFERENCES reconciliation_set (reconciliation_set_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE reconciliation
ADD CONSTRAINT reconciliation_set_id_reconciliation_fk1
FOREIGN KEY (reconciliation_set_id)
REFERENCES reconciliation_set (reconciliation_set_id)
ON DELETE CASCADE
ON UPDATE CASCADE;
...
ALTER TABLE family_attribute
ADD CONSTRAINT family_family_attribute_fk1
...
ALTER TABLE protein_tree_node_path
ADD CONSTRAINT protein_tree_node_protein_tree_node_path_fk1
FOREIGN KEY (parent_node_id)
REFERENCES protein_tree_node (node_id)
ON DELETE CASCADE;

ALTER TABLE protein_tree_node_path
ADD CONSTRAINT protein_tree_node_protein_tree_node_path_fk2
FOREIGN KEY (child_node_id)
REFERENCES protein_tree_node (node_id)
ON DELETE CASCADE;
