...
ALTER TABLE species_tree_node_path MODIFY COLUMN path LONGVARCHAR(255) COMMENT 'This will get very large for big trees and may be too unwieldy to use in the database, may need to make the path an attribute with rank field.';
...
CREATE TABLE reconciliation_node_attribute (
                ...
                rank SMALLINT(3) DEFAULT 0 NOT NULL,
                source_id INT(10),
                PRIMARY KEY (reconciliation_node_map_attribute_id)
);
...
-- LOTS OF KEYS BELOW
-- THESE NEED TO BE MOVED UP TO UNDER EACH INDIVIDUAL TABLE


ALTER TABLE reconciliation_attribute ADD CONSTRAINT source_reconciliation_attribute_fk
FOREIGN KEY (source_id)
REFERENCES source (source_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE species_tree_node_attribute ADD CONSTRAINT source_species_tree_node_attribute_fk
FOREIGN KEY (source_id)
REFERENCES source (source_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE species_tree_attribute ADD CONSTRAINT source_species_tree_attribute_fk
FOREIGN KEY (source_id)
REFERENCES source (source_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE reconciliation_node_attribute ADD CONSTRAINT source_reconciliation_node_attribute_fk
FOREIGN KEY (source_id)
REFERENCES source (source_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE protein_tree_attribute ADD CONSTRAINT source_protein_tree_attribute_fk
FOREIGN KEY (source_id)
REFERENCES source (source_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE member_attribute ADD CONSTRAINT source_member_attribute_fk
FOREIGN KEY (source_id)
REFERENCES source (source_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE source_attribute ADD CONSTRAINT source_source_attribute_fk
FOREIGN KEY (source_id)
REFERENCES source (source_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE protein_tree_node_attribute ADD CONSTRAINT source_protein_tree_node_attribute_fk
FOREIGN KEY (source_id)
REFERENCES source (source_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE protein_tree_member ADD CONSTRAINT member_protein_tree_member_fk
FOREIGN KEY (member_id)
REFERENCES member (member_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE member_attribute ADD CONSTRAINT member_member_attribute_fk
FOREIGN KEY (member_id)
REFERENCES member (member_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE cvterm ADD CONSTRAINT ontology_term_fk
FOREIGN KEY (cv_id)
REFERENCES cv (cv_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE cvtermpath ADD CONSTRAINT cv_cvtermpath_fk
FOREIGN KEY (cv_id)
REFERENCES cv (cv_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE reconciliation_attribute ADD CONSTRAINT term_reconciliation_set_attribute_fk
FOREIGN KEY (cvterm_id)
REFERENCES cvterm (cvterm_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE species_tree_attribute ADD CONSTRAINT term_species_tree_attribute_fk
FOREIGN KEY (cvterm_id)
REFERENCES cvterm (cvterm_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE reconciliation_node_attribute ADD CONSTRAINT term_reconciliation_node_map_attribute_fk
FOREIGN KEY (cvterm_id)
REFERENCES cvterm (cvterm_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE protein_tree_attribute ADD CONSTRAINT term_protein_tree_attribute_fk
FOREIGN KEY (cvterm_id)
REFERENCES cvterm (cvterm_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE member_attribute ADD CONSTRAINT term_member_attribute_fk
FOREIGN KEY (cvterm_id)
REFERENCES cvterm (cvterm_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE source_attribute ADD CONSTRAINT cvterm_source_attribute_fk
FOREIGN KEY (cvterm_id)
REFERENCES cvterm (cvterm_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE dbxrefprop ADD CONSTRAINT cvterm_dbxrefprop_fk
FOREIGN KEY (type_id)
REFERENCES cvterm (cvterm_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE protein_tree_node_attribute ADD CONSTRAINT cvterm_protein_tree_node_attribute_fk
FOREIGN KEY (cvterm_id)
REFERENCES cvterm (cvterm_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE protein_tree_node ADD CONSTRAINT protein_tree_protein_tree_node_fk
FOREIGN KEY (protein_tree_id)
REFERENCES protein_tree (protein_tree_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE reconciliation ADD CONSTRAINT protein_tree_reconciliation_set_fk
FOREIGN KEY (protein_tree_id)
REFERENCES protein_tree (protein_tree_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE protein_tree_attribute ADD CONSTRAINT protein_tree_protein_tree_attribute_fk
FOREIGN KEY (protein_tree_id)
REFERENCES protein_tree (protein_tree_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE species_tree_node ADD CONSTRAINT species_tree_species_tree_node_fk
FOREIGN KEY (species_tree_id)
REFERENCES species_tree (species_tree_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE reconciliation ADD CONSTRAINT species_tree_reconciliation_set_fk
FOREIGN KEY (species_tree_id)
REFERENCES species_tree (species_tree_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE species_tree_attribute ADD CONSTRAINT species_tree_species_tree_attribute_fk
FOREIGN KEY (species_tree_id)
REFERENCES species_tree (species_tree_id)
ON DELETE CASCADE
ON UPDATE CASCADE;
...
*/
ALTER TABLE reconciliation_node ADD CONSTRAINT reconciliation_set_reconciliation_node_map_fk
FOREIGN KEY (reconciliation_id)
REFERENCES reconciliation (reconciliation_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE reconciliation_attribute ADD CONSTRAINT reconciliation_set_reconciliation_set_attribute_fk
FOREIGN KEY (reconciliation_id)
REFERENCES reconciliation (reconciliation_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE species_tree_node_attribute ADD CONSTRAINT species_tree_node_species_tree_node_attribute_fk
FOREIGN KEY (species_tree_node_id)
REFERENCES species_tree_node (species_tree_node_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE species_tree_node_path ADD CONSTRAINT species_tree_node_species_tree_node_path_fk_1
FOREIGN KEY (parent_node_id)
REFERENCES species_tree_node (species_tree_node_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE species_tree_node_path ADD CONSTRAINT species_tree_node_species_tree_node_path_fk_2
FOREIGN KEY (child_node_id)
REFERENCES species_tree_node (species_tree_node_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE protein_tree_tag ADD CONSTRAINT protein_tree_node_protein_tree_tag_fk
FOREIGN KEY (node_id)
REFERENCES protein_tree_node (node_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE protein_tree_member ADD CONSTRAINT protein_tree_node_protein_tree_member_fk
FOREIGN KEY (node_id)
REFERENCES protein_tree_node (node_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE protein_tree_member_score ADD CONSTRAINT protein_tree_node_protein_tree_member_score_fk
FOREIGN KEY (node_id)
REFERENCES protein_tree_node (node_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE protein_tree_hmmprofile ADD CONSTRAINT protein_tree_node_protein_tree_hmmprofile_fk
FOREIGN KEY (node_id)
REFERENCES protein_tree_node (node_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE protein_tree_stable_id ADD CONSTRAINT protein_tree_node_protein_tree_stable_id_fk
FOREIGN KEY (node_id)
REFERENCES protein_tree_node (node_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE reconciliation_node ADD CONSTRAINT protein_tree_node_reconciliation_node_map_fk
FOREIGN KEY (node_id)
REFERENCES protein_tree_node (node_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE protein_tree_node_attribute ADD CONSTRAINT protein_tree_node_protein_tree_node_attribute_fk
FOREIGN KEY (node_id)
REFERENCES protein_tree_node (node_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE reconciliation_node_attribute ADD CONSTRAINT reconciliation_node_map_reconciliation_node_map_attribute_fk
